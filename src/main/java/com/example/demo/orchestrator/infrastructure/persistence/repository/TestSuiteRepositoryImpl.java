...
import com.example.demo.orchestrator.infrastructure.persistence.mapper.TestSuiteMapper;
...
public class TestSuiteRepositoryImpl implements TestSuiteRepository {
    ...
    private final com.example.demo.orchestrator.infrastructure.persistence.jpa.TestSuiteRepository jpaRepository;
    private final TestSuiteMapper mapper;

    public TestSuiteRepositoryImpl(
            com.example.demo.orchestrator.infrastructure.persistence.jpa.TestSuiteRepository jpaRepository,
