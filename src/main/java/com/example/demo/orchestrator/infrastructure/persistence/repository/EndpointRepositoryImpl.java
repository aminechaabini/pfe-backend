...
import com.example.demo.orchestrator.domain.spec.EndpointRepository;
...
import com.example.demo.orchestrator.infrastructure.persistence.mapper.EndpointMapper;
...
public class EndpointRepositoryImpl implements EndpointRepository {
    ...
    private final com.example.demo.orchestrator.infrastructure.persistence.jpa.EndpointRepository jpaRepository;
    private final EndpointMapper mapper;

    public EndpointRepositoryImpl(
            com.example.demo.orchestrator.infrastructure.persistence.jpa.EndpointRepository jpaRepository,
