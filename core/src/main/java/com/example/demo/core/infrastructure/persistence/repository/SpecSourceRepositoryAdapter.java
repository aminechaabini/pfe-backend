...
import com.example.demo.core.infrastructure.persistence.mapper.SpecSourceMapper;
 ...
 */
@Repository
public class SpecSourceRepositoryAdapter implements SpecSourceRepository {

    private final com.example.demo.core.infrastructure.persistence.jpa.SpecSourceRepository jpaRepository;
    private final SpecSourceMapper mapper;

    public SpecSourceRepositoryAdapter(
            com.example.demo.core.infrastructure.persistence.jpa.SpecSourceRepository jpaRepository,
